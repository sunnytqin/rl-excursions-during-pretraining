...
const Markdown = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="md-shell svelte-1jl4dmm"${add_attribute("this", shellEl, 0)}><div class="md-grid svelte-1jl4dmm"><div class="md-output space-y-6 svelte-1jl4dmm"${add_attribute("this", container, 0)}>${each(sections, (item, i) => {
    return `${item.type === "chunk" ? `${item.chunk.type === "text" ? `<div class="md-output svelte-1jl4dmm"><!-- HTML_TAG_START -->${toHtml(item.chunk.content)}<!-- HTML_TAG_END --></div>` : `${item.chunk.type === "jumpbox" ? `${validate_component(Jumpbox, "Jumpbox").$$render($$result, { id: item.chunk.id }, {}, {})}` : `${item.chunk.type === "small" ? `<div class="md-output text-sm sm-block svelte-1jl4dmm"><!-- HTML_TAG_START -->${toHtml(item.chunk.content)}<!-- HTML_TAG_END --></div>` : `${item.chunk.type === "callout" ? `${validate_component(CalloutBox, "CalloutBox").$$render(
      $$result,
      {
      ...
      {},
      {}
    )}` : ``}`}`}`}`}` : `${item.type === "section" ? `<details class="foldbox foldbox--h2 svelte-1jl4dmm" data-h2fold="1" open><summary class="foldbox__summary foldbox__summary--h2"><span class="foldbox__caret" aria-hidden="true"></span> <span class="foldbox__h2 md-output svelte-1jl4dmm"><!-- HTML_TAG_START -->${item.heading.html}<!-- HTML_TAG_END --> </span></summary> <div class="foldbox__body foldbox__body--h2 svelte-1jl4dmm">${each(buildH3Sections(item.children), (sub, j) => {
      return `${sub.type === "chunk" ? `${sub.chunk.type === "callout" && isPinnedTakeaway(sub.chunk) ? `<div class="foldbox__pin svelte-1jl4dmm">${validate_component(CalloutBox, "CalloutBox").$$render(
        $$result,
        {
        ...
        {},
        {}
      )} </div>` : `${sub.chunk.type === "text" ? `<div class="md-output svelte-1jl4dmm"><!-- HTML_TAG_START -->${toHtml(sub.chunk.content)}<!-- HTML_TAG_END --></div>` : `${sub.chunk.type === "jumpbox" ? `${validate_component(Jumpbox, "Jumpbox").$$render($$result, { id: sub.chunk.id }, {}, {})}` : `${sub.chunk.type === "small" ? `<div class="md-output text-sm sm-block svelte-1jl4dmm"><!-- HTML_TAG_START -->${toHtml(sub.chunk.content)}<!-- HTML_TAG_END --></div>` : `${sub.chunk.type === "callout" ? `${validate_component(CalloutBox, "CalloutBox").$$render(
        $$result,
        {
          variant: sub.chunk.variant,
          title: sub.chunk.title,
        ...
        {},
        {}
      )}` : ``}`}`}`}`}`}` : `${sub.type === "subsection" ? `<details class="foldbox foldbox--h3 svelte-1jl4dmm" data-h3fold="1"><summary class="foldbox__summary foldbox__summary--h3"><span class="foldbox__caret" aria-hidden="true"></span> <span class="foldbox__h3 md-output svelte-1jl4dmm"><!-- HTML_TAG_START -->${sub.heading.html}<!-- HTML_TAG_END --> </span></summary> <div class="foldbox__body foldbox__body--h3 svelte-1jl4dmm">${each(sub.children, (chunk, k) => {
        return `${chunk.type === "callout" && isPinnedTakeaway(chunk) ? `<div class="foldbox__pin svelte-1jl4dmm">${validate_component(CalloutBox, "CalloutBox").$$render(
          $$result,
          {
          ...
          {},
          {}
        )} </div>` : `${chunk.type === "text" ? `<div class="md-output svelte-1jl4dmm"><!-- HTML_TAG_START -->${toHtml(chunk.content)}<!-- HTML_TAG_END --></div>` : `${chunk.type === "jumpbox" ? `${validate_component(Jumpbox, "Jumpbox").$$render($$result, { id: chunk.id }, {}, {})}` : `${chunk.type === "small" ? `<div class="md-output text-sm sm-block svelte-1jl4dmm"><!-- HTML_TAG_START -->${toHtml(chunk.content)}<!-- HTML_TAG_END --></div>` : `${chunk.type === "callout" ? `${validate_component(CalloutBox, "CalloutBox").$$render(
          $$result,
          {
            variant: chunk.variant,
            title: chunk.title,
  ...
  })}</div> ${footnotes.length ? `<aside class="md-footnotes svelte-1jl4dmm" aria-label="Footnotes"${add_attribute("this", footnoteAside, 0)}><ol class="svelte-1jl4dmm"${add_attribute("this", footnoteList, 0)}>${each(footnotes, (fn) => {
    return `<li${add_attribute("id", `fn-${fn.safeId}`, 0)}${add_attribute("title", fn.id, 0)} class="svelte-1jl4dmm"><span class="fn-label svelte-1jl4dmm">${escape(fn.num)}</span> <span class="fn-text svelte-1jl4dmm"><!-- HTML_TAG_START -->${fn.html}<!-- HTML_TAG_END --></span> </li>`;
  })}</ol></aside>` : ``}</div> </div>`;
});
const css = {
