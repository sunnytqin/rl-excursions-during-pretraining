 ...
 * and wrapping it in a container with `style="overflow-x:auto;"`
 */
declare function align(x: string, options?: KatexOptionsDisplay): string;
/**
 * Renders align* environment in displayed mode
 *
 * Takes a TeX expression and outputs a HTML string for the rendered math in displayed mode
 ...
 * and wrapping it in a container with `style="overflow-x:auto;"`
 */
declare function alignStar(x: string, options?: KatexOptionsDisplay): string;
/**
 ...
 * and wrapping it in a container with `style="overflow-x:auto;"`
 */
declare function gather(x: string, options?: KatexOptionsDisplay): string;
/**
 * Renders gather* environment in displayed mode
 *
 * Takes a TeX expression and outputs a HTML string for the rendered math in displayed mode
 ...
 */
declare function html(x: string): string;
/**
 * custom latex is removed for html purposes
 * to be used in conjunction with mathlifier2
 */
declare function tex(x: string): string;
/**
 * inject the relevant html
 * to be used in conjunction with mathlifier2
 */
declare function htmlTex(x: string, y: string): string;

export { align, alignStar, alignat, alignatStar, bold, display, em, emph, eqn, eqnStar, equation, equationStar, gather, gatherStar, html, htmlTex, linebreak, math, newParagraph, newline, strong, tex };
